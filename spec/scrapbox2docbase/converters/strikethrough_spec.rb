RSpec.describe Scrapbox2docbase::Converters::Strikethrough do
  describe '#convert!' do
    context 'When passing a single line' do
      subject(:line) { ['[- Strikethrough]'] }
      before do
        converter = Scrapbox2docbase::Converters::Strikethrough.new(line)
        converter.convert!
      end
    ...
    context 'When passing a single line including a multiple strikethrough with heading' do
      ...
      before do
        converter = Scrapbox2docbase::Converters::Strikethrough.new(lines)
        converter.convert!
      end
