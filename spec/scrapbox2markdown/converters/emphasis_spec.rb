RSpec.describe Scrapbox2markdown::Converters::Emphasis do
  describe '#convert!' do
    context 'When passing a single line' do
      subject(:line) { ['[[Emphasis]]'] }
      before do
        converter = Scrapbox2markdown::Converters::Emphasis.new(line)
        converter.convert!
      end
    ...
    context 'When passing a multiple line' do
      ...
      before do
        converter = Scrapbox2markdown::Converters::Emphasis.new(lines)
        converter.convert!
      end
